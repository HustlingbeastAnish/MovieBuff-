...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        homebg:
          "url('https://images.unsplash.com/photo-1615986201152-7686a4867f30?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1025&q=80')",
        navlogo:
